...
const UpdateCoffee = () => {
    ...
    return (
        <div className='bg-[#f7f6f5] p-24'>
            <h1 className='text-5xl text-success mb-6 font-serif font-bold'>Update Coffee</h1>
            ...
            <div className='md:flex gap-5 mb-8'>
                ...
                <div className="form-control md:w-1/2">
                    ...
                    <label className="input-group input-group-vertical">
                        <input type="text" name='taste' defaultValue={taste} className="input input-bordered md:w-full" />
                    </label>
                </div>
            </div>
            <div className='md:flex gap-5 mb-8'>
                ...
                <div className="form-control md:w-1/2">
                    ...
                    <label className="input-group input-group-vertical">
                        <input type="details" name='details' defaultValue={details} className="input input-bordered md:w-full" />
                    </label>
                </div>
            </div>
            ...
            <div className='grid justify-items-center mb-8'>
                <div className="form-control md:w-1/2">
                    ...
                    <button className="btn btn-outline btn-success text-xl font-serif">Update Coffee</button>
                </div>
            </div>
        </form>
        </div>
